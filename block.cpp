...
#pragma HLS LOOP_TRIPCOUNT max=224 min=224
...
#pragma HLS UNROLL
				...
				ap_int<Accbit> pw2_acc   =  buf[tm*NUM+ii][t*BLOCK+r*Tc+c];
...
bool flag=true;
    ...
    for(unsigned cnt=0; cnt<loops; cnt++){
    	...
    	if(cnt==0){
    		DW_Engine<Tr1,Tc1,DwTn1,Abit1,Wbit1,Accbit2,InWidth1,DwWidth1,BN_int1,SIZE1,NormWidth1,NormSize1>
    		     		    		(In_ddrsrc,Wt7x7_ddrsrc,Normq_ddrsrc,coldbuff0,row,col,R1,C1,N1);
    	}else if(cnt == 1){

    		DW_Engine<Tr1,Tc1,DwTn1,Abit1,Wbit1,Accbit2,InWidth1,DwWidth1,BN_int1,SIZE1,NormWidth1,NormSize1>
    		     		    		(In_ddrsrc,Wt7x7_ddrsrc,Normq_ddrsrc,coldbuff1,row,col,R1,C1,N1);
    		...
    		if(flag){
        		...
        		QPW2DDR_Reduce<PwTn1,Tr1,Tc1,Abit1,Accbit1,Obit1,OutWidth1,ScaleBit1,Scale_int1,SIZE2>(PWObuff0,Branch_ddr,Out_ddr,pre_row2,pre_col2,N1,C1,rescale2,id_rescale);
        		flag = !flag;
    		}else{
        		DW_Engine<Tr1,Tc1,DwTn1,Abit1,Wbit1,Accbit2,InWidth1,DwWidth1,BN_int1,SIZE1,NormWidth1,NormSize1>
        		    		     		    		(In_ddrsrc,Wt7x7_ddrsrc,Normq_ddrsrc,coldbuff1,row,col,R1,C1,N1);
        		...
        		PW_PW_Fused<Tr1,Tc1,DwTn1,PwTn1,Tm1,Abit1,Wbit1,Accbit1,Pw1Width1,Pw2Width1,ScaleBit1,Scale_int1,SIZE1,SIZE2>
        		    					             (Wt1_ddrsrc,Wt2_ddrsrc,coldbuff0,PWObuff0,M1,N1,rescale1);
        		QPW2DDR_Reduce<PwTn1,Tr1,Tc1,Abit1,Accbit1,Obit1,OutWidth1,ScaleBit1,Scale_int1,SIZE2>(PWObuff1,Branch_ddr,Out_ddr,pre_row2,pre_col2,N1,C1,rescale2,id_rescale);
    			flag = !flag;
    ...
    if(loops > 1){
        ...
        if(flag){
        	QPW2DDR_Reduce<PwTn1,Tr1,Tc1,Abit1,Accbit1,Obit1,OutWidth1,ScaleBit1,Scale_int1,SIZE2>(PWObuff0,Branch_ddr,Out_ddr,pre_row,pre_col,N1,C1,rescale2,id_rescale);
        }else{
        	QPW2DDR_Reduce<PwTn1,Tr1,Tc1,Abit1,Accbit1,Obit1,OutWidth1,ScaleBit1,Scale_int1,SIZE2>(PWObuff1,Branch_ddr,Out_ddr,pre_row,pre_col,N1,C1,rescale2,id_rescale);
        }
    }else{
    	PW_PW_Fused<Tr1,Tc1,DwTn1,PwTn1,Tm1,Abit1,Wbit1,Accbit1,Pw1Width1,Pw2Width1,ScaleBit1,Scale_int1,SIZE1,SIZE2>
    	        	        		    					             (Wt1_ddrsrc,Wt2_ddrsrc,coldbuff0,PWObuff0,M1,N1,rescale1);
    	QPW2DDR_Reduce<PwTn1,Tr1,Tc1,Abit1,Accbit1,Obit1,OutWidth1,ScaleBit1,Scale_int1,SIZE2>(PWObuff0,Branch_ddr,Out_ddr,0,0,N1,C1,rescale2,id_rescale);
    }
