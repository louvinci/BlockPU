...
int main(){
	...
	unsigned R1=14,C1=14,N1=96,M1=96*6;
	//unsigned R1=14,C1=14,N1=128,M1=128*4;
    ...
    QBPU2((ABWtype*)in,(NWtype*)norm_wt,(WBWtype*)dw_wt,(WBWtype2*)pw1_wt,(WBWtype3*)pw2_wt,(OBWtype*)in,(OBWtype*)hw_res,
